...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    platform: "TV App",
    tags: ["AI Search", "Voice Control", "Streaming"],
    year: 2025,
    link: "#",
    gallery: SAMPLE_GALLERY,
    fullDescription: LOREM_IPSUM
  },
  {
    id: "2",
    ...
    tags: ["Child Safety", "Real-time GPS", "AI Insights"],
    year: 2025,
    link: "#",
    gallery: SAMPLE_GALLERY,
    fullDescription: LOREM_IPSUM
  },
  {
    ...
    role: "Lead UX/UI Designer",
    platform: "iOS, Android, Web",
    tags: ["EdTech", "Sports Management", "SaaS"],
    year: 2025,
    link: "#",
    gallery: SAMPLE_GALLERY,
    fullDescription: LOREM_IPSUM
  },
  {
    ...
    tags: ["Accessibility", "Computer Vision", "AI"],
    year: 2024,
    link: "#",
    gallery: SAMPLE_GALLERY,
    fullDescription: LOREM_IPSUM
  },
  {
    ...
    tags: ["AR", "Accessibility", "Vision Pro"],
    year: 2024,
    link: "#",
    gallery: SAMPLE_GALLERY,
    fullDescription: LOREM_IPSUM
